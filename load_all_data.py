...
def load_all_data():
    """
    Load 20news data from either raw text or from a cached Python shelve file.
    
    :return: tuple containing num_words, num_training, num_testing, train_data, test_data, train_labels, test_labels
    :rtype: tuple
    """
    shelf_file = 'loaded_tweets'

    start_time = time.time()

    if os.path.exists(shelf_file + ".db"):

        print("Found shelved file. Loading tweets data from file.")
